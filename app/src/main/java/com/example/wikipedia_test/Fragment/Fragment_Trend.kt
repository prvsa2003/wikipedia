...
import com.example.wikipedia_test.Adapter.TrendAdapter
import com.example.wikipedia_test.Data.ItemPost
import com.example.wikipedia_test.Activity.MainActivity2
import com.example.wikipedia_test.databinding.FragmentTrendBinding
const val SEND_DATA_TO_SECOND_DITAIL_ACTIVITY = "SENDDATA"
class Fragment_Trend : Fragment(), ItemEvent {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclertrend.recycledViewPool.setMaxRecycledViews(0 , 0)
    }
